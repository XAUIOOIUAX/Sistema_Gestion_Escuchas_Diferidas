"""FlowLayout: acomoda los widgets en fila y los pasa a la línea siguiente
cuando no entran en el ancho disponible (patrón estándar de Qt).

Se usa para la barra de filtros de la Tabla TOTAL, así nunca se cortan aunque
la ventana sea angosta.
"""
